...
class UsersExpiredEventsView extends StatefulWidget {
  const UsersExpiredEventsView({super.key});

  @override
  State<UsersExpiredEventsView> createState() => _UsersExpiredEventsViewState();
}

class _UsersExpiredEventsViewState extends State<UsersExpiredEventsView> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: EventRoomService().getExpiredEventRoomsByLoggedUser(),
